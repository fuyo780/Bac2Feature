...
qiime feature-classifier classify-sklearn --i-classifier $ref_classifier_path --i-reads $intermediate_seq_qza_path --o-classification $intermediate_tax_qza_path --p-n-jobs $threads > /dev/null
